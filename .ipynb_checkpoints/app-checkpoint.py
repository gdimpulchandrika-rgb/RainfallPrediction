...
data = pd.read_csv(r"C:\Users\dadof\PycharmProjects\RainFall\.venv\RainfallPrediction\Dataset\Dataset.csv")
# data.head()
...
file = open(r"C:\Users\dadof\PycharmProjects\RainFall\.venv\RainfallPrediction\ModelFile\model.pkl","wb")
